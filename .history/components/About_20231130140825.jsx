          ...
          <div className="flex-1">
            <Tabs defaultValue="personal">
              <TabsList className="w-full grid xl:grid-cols-3 xl:max-w-[520px] xl:border dark:border-none">
                <TabsTrigger className='w-[]' value="personal">Personal Info</TabsTrigger>
                <TabsTrigger className='w-[]' value="qualifications">Qualifications</TabsTrigger>
                <TabsTrigger className='w-[]' value="skills">Skills</TabsTrigger>
              </TabsList>
              {/* tabs content */}
