          ...
          <div className="flex-1">
            <Tabs defaultValue="personal">
              <TabsList className="w-full grid xl:grid-cols-3 xl:max-w-[520px] xl:border dark:border-none">
                <TabsTrigger className value="personal">Personal Info</TabsTrigger>
                <TabsTrigger className value="qualifications">Qualifications</TabsTrigger>
                <TabsTrigger className value="skills">Skills</TabsTrigger>
              </TabsList>
              {/* tabs content */}
