...
const Hero = () => {
  return (
    <section className="py-12 xl:py-24 bg-hero bg-no-repeat bg-bottom bg-cover dark:bg-none">
      <div className="flex justify-between gap-x-8">
        {/* text */}
        <div className="flex  flex-col justify-center mx-auto xl:mx-32 text-center xl:text-left">
